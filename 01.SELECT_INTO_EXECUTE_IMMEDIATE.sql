...
-- 5. Utilizând un tip de dat? înregistrare definit de utilizator, s? se afi?eze categoria care are id = 1
set serveroutput on;
declare
...
-- 6. Utilizând un tip de dat? înregistrare de acela?i tip cu tabela instructori 
--s? se afi?eze sal al instructorului cu id 1
...
-- 7. Utilizând un tip de dat? înregistrare de acela?i tip cu un rând din tabela 
--instructori s? se afi?eze denumirea fiec?rei categorie de la id-ul: 1,2,3,4,5
declare
